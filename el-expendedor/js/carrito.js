...
/** FUNCION PARA MOSTRAR PRODCUTOS EN CARRITO, SUMAR, RESTAR UNIDADES y ELIMINAR**/
            ...
            div.innerHTML = `
                ...
                <div class="carrito-producto-cantidad">
                    ...
                    <div class="cantidad-botones">
                        <button class="boton-restar" data-id="${producto.id}">-</button>
                        <p>${producto.cantidad}</p>
                        <button class="boton-sumar" data-id="${producto.id}">+</button>
                    </div>
                </div>
